...
?	1.�ڿ����岻����uboot��ʱ����������Hitool��������дuboot��kernel���ļ�ϵͳ���ڿ������Ѵ���uboot��ʱ����	�ǿ��Բ���tftp��������Щ����uboot��kernel���ļ�ϵͳ��

?	2.�ڹٷ�����SDK�������������õĸ��ļ�ϵͳ����ֱ�ӽ��侵���ļ���д���������ϡ����Ҫ�����Լ���Ӧ�ó���	����ִ���ļ��������ļ������ļ��ȿ�������Ӧ��Ŀ¼���ɡ�

?	3.���ھ����ļ�������������ֱ�ӵ�osdrv��ֱ��ʹ��make������룬Ҳ�ɵ������롣���絽osdrv/pub/pcĿ¼��ȥ��	���������������yaffs2��ʽ��ϵͳ����Hi3559AV100֧��yaffs2��ʽ���ļ�ϵͳ��

?	*./mkyaffs2image100 <���ļ�ϵͳ���ڵ�ַ> <���ɾ����ļ���> <Pagesize><ECC>*	

?    4.�������ǿ���ֱ������NFS�����ļ���������Ӧ�Ŀ����������ļ�ϵͳ���ǿ����ڹ��غ�ֱ����cp�������������	����ص��ļ���

### ����������������

?	1.��linuxϵͳ��multi-core��
...
>
> ע��mtdparts=hinand��ʾΪNand Flash��mtdparts=hi_sfc��ʾΪSPI NAND FLASH
>
> *setenv bootcmd 'nand read 0x44000000 0x100000 0x900000;bootm 0x44000000'*
>
> *saveenv*
>
> ע�ͣ�<OS�ڴ����><�豸���ںţ�������><�ڼ���������><�ļ�ϵͳ��ʽ><dlash����>
>
> ע�⣺������uboot��kernel��roofts�Ĵ�СʱӦע�����дʱ������һ�£��������ܳɹ����ӻ��������������ϵͳ
>
> 
...
### ����Ubuntu 16.04ϵͳ��NFS�İ�װ��ʹ��

[ʹ��ָ��]: https://blog.csdn.net/csdn_duomaomao/article/details/77822883

### �ģ���NFS�����ļ�ʱ����ͨ������

?	��Linux�µ��ն����������������

> *ifconfig eth0 hw ether FA:5A:E1:B1:89:75*           //���ÿ�������̫��������ַ
> *ifconfig eth0 192.168.0.101 netmask 255.255.255.0*  //���ÿ�����ip�����룬��Ҫ����дʱ��������ͬ
> *route  add default gw 192.168.0.1*                //�������أ����ڷ������Ϳ����崦�ڲ�ͬ����ʱ���໥ͨ��
>
> ping 192.168.0.100                                       //����Ƿ����óɹ���pingͨ
...
>>>>>>> 3a035c73d92e1e57a20e573a2fc4c2283a5db136
